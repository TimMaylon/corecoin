...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 4495 or testnet: 14495)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 4496 or testnet: 14496)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Corecoin Wiki for SSL setup instructions)") + "\n" +
