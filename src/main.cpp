...
uint256 hashGenesisBlock("0xf8a626349f310aa1cb0864e56b51f36dbef01d05fb8bba057e5bb00a4bf89909");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Corecoin: starting difficulty is 1 / 2^12
...
{
    // Corecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Corecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf8a626349f310aa1cb0864e56b51f36dbef01d05fb8bba057e5bb00a4bf89909");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1437818284, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "25/Jul/2015 NY TIMES JAN 9 2015 Job Growth Fails to Help Paychecks of Workers";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1437818284;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3092503;
        ...
        assert(block.hashMerkleRoot == uint256("0xf302f8f680c4c86dd9305853140ac90fe98a96f61393024b4e1ce9224bf54752"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // Corecoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CorecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CorecoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static CorecoinMiner(CWallet *pwallet)
{
    printf("CorecoinMiner started\n");
    ...
    try { loop {
        ...
        printf("Running CorecoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("CorecoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&CorecoinMiner, pwallet));
}
